...
def plot_map_night_screen_index_and_log2_income(city: List[mt.City]):
    ...
    folium_map = plotting.map.plot_folium_map(data=high_night_screen_index, name='high_nsi', column='night_screen_index', color='blue', opacity=0.5, folium_map=folium_map, legend=False)
    low_night_screen_index = night_screen_index_and_income.loc[night_screen_index_and_income['night_screen_index'] < qs[0]]
    folium_map = plotting.map.plot_folium_map(data=low_night_screen_index, name='low_nsi', column='night_screen_index', color='red', opacity=0.5, folium_map=folium_map, legend=False)

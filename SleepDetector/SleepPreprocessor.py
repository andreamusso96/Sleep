...
class SleepPreprocessor:
    ...
    @staticmethod
    def remove_weekends(total_traffic: xr.DataArray):
    ...
    @staticmethod
    def remove_anomalies(total_traffic: xr.DataArray, city: City):
        anomaly_dates = Anomalies.get_anomaly_dates_by_city(city=city)
        return total_traffic.drop_sel(day=anomaly_dates)

    @staticmethod
    def to_time_series_format(total_traffic: xr.DataArray):
